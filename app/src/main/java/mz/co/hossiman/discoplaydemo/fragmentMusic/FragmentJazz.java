...
public class FragmentJazz extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.music_jazz_fragment, container, false);
        myrecyclerview = (RecyclerView) view.findViewById(R.id.jazz_recyclerview);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lstMusica.add(new Musica("Morreira Xonguissa", "Mahulelele", "02:57"));
        lstMusica.add(new Musica("Jimi Jlhujlhu", "Tote", "04:07"));
