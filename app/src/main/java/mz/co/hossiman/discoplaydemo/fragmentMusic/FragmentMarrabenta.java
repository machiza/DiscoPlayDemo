...
public class FragmentMarrabenta extends Fragment {

    View view;
    private RecyclerView myrecyclerview;
    private List<Musica> lstMusica;

    public FragmentMarrabenta() {
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.music_marrabenta_fragment, container, false);
        myrecyclerview = (RecyclerView) view.findViewById(R.id.marrabenta_recyclerview);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lstMusica.add(new Musica("Dilon Gigi", "Marrabenta", "03:57"));
        lstMusica.add(new Musica("Phaniphumo", "Ndzicumbuka", "04:07"));
