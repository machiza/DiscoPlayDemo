...
public class FragmentRock extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.music_rock_fragment, container, false);
        myrecyclerview = (RecyclerView) view.findViewById(R.id.rock_recyclerview);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lstMusica.add(new Musica("Rock Felex", "Nao da", "05:57"));
        lstMusica.add(new Musica("Scrash", "Niganguise", "04:07"));
        lstMusica.add(new Musica("Ngan's roses", "Bed Roses", "03:31"));
